...
Brand Portal 2024.10.0 ist eine interne Version, mit der die kritischen Probleme behoben werden. Weitere Informationen finden Sie in den aktuellen [Brand Portal-Versionshinweisen](brand-portal-release-notes.md).
...
Brand Portal 2021.08.0 ist eine interne Version, in der Geschäftsprofile für Unternehmens- und Team-Kunden eingeführt werden, um Organisationen eine bessere Kontrolle über ihre Assets zu ermöglichen. Die Benutzenden verfügen jetzt über organisationsspezifische Berechtigungen für die neuen und migrierten Organisationen. Während der Migration werden alle bestehenden Adobe ID-Konten zu Business IDs migriert.
...
* [Domain-Vertrauen](https://helpx.adobe.com/de/enterprise/admin-guide.html/enterprise/using/set-up-identity.html#directory-trusting)
...
Mit Brand Portal 2021.02.0 wurde AEM Assets as a Cloud Service um den Aktivierungs-Workflow und die Asset-Beschaffungsfunktion erweitert. Außerdem wurde der Download von Assets verbessert und es wurden wichtige Fehlerbehebungen vorgenommen. Damit können die Admins jetzt auch das Standard-Download-Verhalten von Ordnern und Sammlungen sowie den Massen-Download von Assets auf Mandantenebene konfigurieren. Der **[!UICONTROL Verwendungsbericht]** in Brand Portal wurde auch geändert und spiegelt nun die aktiven Brand Portal-Benutzer wider.
...
Die Cloud Manager-Benutzenden lösen den Aktivierungs-Workflow aus, der die erforderlichen Konfigurationen im Backend erstellt und Brand Portal auf derselben IMS-Org wie die AEM Assets as a Cloud Service-Instanz aktiviert.
...
Die Asset-Beschaffungsfunktion wird jetzt in AEM Assets as a Cloud Service unterstützt. Die Funktion ist standardmäßig für alle Cloud Service-Benutzer aktiviert. Die zugelassenen Brand Portal-Benutzenden können zur Asset-Beschaffung beitragen, indem sie neue Assets in die Beitragsordner hochladen und diese von Brand Portal in AEM Assets as a Cloud Service veröffentlichen. Admins können Beiträge von Brand Portal-Benutzenden überprüfen und genehmigen, bevor sie sie an andere Benutzende verteilen.
...
Melden Sie sich bei Ihrem Brand Portal-Mandanten als Administrator an und navigieren Sie zu **[!UICONTROL Tools]** > **[!UICONTROL Download]**. Die Admins können die Einstellung **[!UICONTROL Asset-Download]** aktivieren, um beim Herunterladen von Ordnern und Sammlungen sowie beim Massen-Download von Assets für jedes Asset einen eigenen Ordner zu erstellen.

![](assets/download-settings-new.png)

Siehe [Herunterladen von Assets aus Brand Portal](https://experienceleague.adobe.com/de/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets).
<!--
...
Brand Portal 2020.10.0 liefert hauptsächlich Verbesserungen, die das Download-Erlebnis vereinfachen, außerdem bietet die Version wichtige Fehlerbehebungen. So wird ein neuer und verbesserter Workflow für Asset-Downloads mit Optionen zum Ausschließen von Ausgabedarstellungen und direkten Downloads vom Panel **[!UICONTROL Ausgabedarstellungen]** eingeführt. Darüber hinaus ermöglicht die neue Version die Konfiguration von Zugriffs- und Download-Rechten für bestimmte Benutzergruppen und bietet eine einfache Navigation von allen Brand Portal-Seiten zu Dateien, Sammlungen und freigegebenen Links. Weitere Informationen finden Sie in den [Brand Portal-Versionshinweisen](brand-portal-release-notes.md).


### Vereinfachtes Download-Erlebnis {#download-dialog}

Bislang standen im Dialogfeld **[!UICONTROL Download]** mehrere Optionen zur Verfügung, z. B. zum Erstellen separater Ordner für jedes Asset, zum Senden von Assets per E-Mail, zur Auswahl von Original-Assets und mehr. Diese Optionen waren für technisch nicht versierte oder neue Benutzende verwirrend, insbesondere beim Herunterladen mehrerer Assets oder Ordner. Außerdem konnten die Benutzenden nicht alle Asset-Ausgabedarstellungen sehen oder eine bestimmte benutzerdefinierte oder dynamische Ausgabedarstellung ausschließen.

Das neue Dialogfeld **[!UICONTROL Download]** verallgemeinert die Auswahl und das Filtern von Assets, wodurch Brand Portal-Benutzende beim Download von Asset-Ausgabedarstellungen leichter die richtigen Entscheidungen treffen können. Im Dialogfeld werden alle ausgewählten Assets und deren Ausgabedarstellungen abhängig von der [**[!UICONTROL Download]**](brand-portal-download-assets.md)-Konfiguration und den **[!UICONTROL Download]**-Einstellungen aufgeführt.
...
Im Dialogfeld **[!UICONTROL Download]** haben Benutzende folgende Möglichkeiten:
...
Der Download-Workflow bleibt für eigenständige Assets, mehrere Assets, Ordner mit Assets, lizenzierte oder nicht lizenzierte Assets und den Download von Assets über einen Freigabe-Link derselbe. Siehe [Schritte zum Herunterladen von Assets aus Brand Portal](https://experienceleague.adobe.com/de/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets).
...
Zuvor konnten Benutzende das Original-Asset und seine Ausgabedarstellungen nur dann im Dialogfeld **[!UICONTROL Ausgabedarstellungen]** anzeigen, wenn die Option **[!UICONTROL Benutzerdefinierte Ausgabedarstellung]** bzw. **[!UICONTROL System-Ausgabedarstellung]** in der **[!UICONTROL Download]**-Konfiguration aktiviert war. Außerdem mussten die Benutzenden alle Asset-Ausgabedarstellungen herunterladen, da es keinen Filter zum Ausschließen bestimmter benutzerdefinierter oder dynamischer Ausgabedarstellungen gab.
...
In Brand Portal 2020.10.0 können die Benutzenden bestimmte Ausgabedarstellungen ausschließen und die ausgewählten Ausgabedarstellungen direkt [aus dem Panel „Ausgabedarstellungen“](brand-portal-download-assets.md#download-assets-from-asset-details-page) auf der Asset-Detailseite herunterladen, ohne dass sie dafür erst das Dialogfeld **[!UICONTROL Download]** öffnen müssen.
...
Brand Portal-Admins können jetzt auf der Asset-Detailseite zusätzlich zu den vorhandenen **[!UICONTROL Download]**-Konfigurationen Einstellungen für Benutzergruppen konfigurieren, damit diese die Original-Assets und/oder Ausgabedarstellungen anzeigen oder herunterladen können.
...
Siehe [Konfigurieren des Asset-Downloads](https://experienceleague.adobe.com/de/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets#configure-download-permissions).
...
Brand Portal-Benutzende können den Dokument-Viewer verwenden, um Seiten und Lesezeichen anzuzeigen, Text zu suchen, ein- und auszuzoomen und durch Seiten zu navigieren. Sie können zu einer bestimmten Seite wechseln, den Viewer an ein Fenster oder einen Bildschirm anpassen und die Sichtbarkeit der Symbolleiste umschalten.
...
Zum bestehenden Workflow zum Herunterladen von Assets aus Brand Portal gehört zwangsläufig das Erscheinen eines **[!UICONTROL Download]**-Dialogfelds mit mehreren Download-Optionen zur Auswahl.

In Brand Portal 6.4.7 können die Brand Portal-Admins die Einstellungen für den **[!UICONTROL Download]** von Assets konfigurieren. Die folgenden Konfigurationen sind verfügbar:
...
* Wenn sowohl die Konfigurationen für **[!UICONTROL benutzerdefinierte Ausgabedarstellungen]** als auch die für **[!UICONTROL Systemausgabedarstellungen]** deaktiviert sind, werden die ursprünglichen Ausgabedarstellungen der Assets ohne ein zusätzliches Dialogfeld heruntergeladen, was den Download für die Benutzenden von Brand Portal vereinfacht.

* Wenn die **[!UICONTROL benutzerdefinierte Ausgabe]** oder die **[!UICONTROL Systemausgabe]** aktiviert ist, wird das Dialogfeld **[!UICONTROL Download]** angezeigt und das ursprüngliche Asset zusammen mit den Asset-Ausgabedarstellungen heruntergeladen. Durch das Aktivieren der Konfiguration **[!UICONTROL Schneller Download]** wird der Download-Prozess beschleunigt.

Basierend auf der Konfiguration bleibt der Download-Workflow für eigenständige Assets, mehrere Assets und Ordner mit Assets derselbe. Dazu gehören auch lizenzierte oder nicht lizenzierte Assets sowie das Herunterladen von Assets über einen Freigabe-Link.
...
>[!NOTE]
>
>Adobe empfiehlt, die AEM-Instanz zu aktualisieren, um das neueste Service Pack zu verwenden.
...
Die AEM-Benutzenden laden eine Zusammenfassung und Baseline-Assets in den Ordner **FREIGEGEBEN** hoch. Dann werden die im Beitragsordner erforderlichen Asset-Typen definiert, um sicherzustellen, dass Brand Portal-Benutzende über die erforderlichen Referenzinformationen verfügen. Die Admins können aktiven Brand Portal-Benutzenden anschließend Zugriff auf den Beitragsordner gewähren, bevor der neu erstellte **Beitragsordner** in Brand Portal veröffentlicht wird.


Nachdem die Person Inhalte zum Ordner **NEU** hinzugefügt hat, kann sie den Beitragsordner wieder in der AEM-Autorenumgebung veröffentlichen. Bitte beachten Sie, dass es einige Minuten dauern kann, bis der Import abgeschlossen ist und die neu veröffentlichten Inhalte in AEM Assets angezeigt werden.
...
Version 6.4.4 von Brand Portal konzentriert sich auf Verbesserungen der Textsuche und häufig geäußerte Kundenwünsche. Weitere Informationen finden Sie in den aktuellen [Brand Portal-Versionshinweisen](brand-portal-release-notes.md).
...
Beispielsweise werden durch die Angabe von **kletter&#42;** alle Assets zurückgegeben, deren Titelphrase Wörter enthält, die mit den Zeichen **kletter** beginnen, wenn das Suchformular in Brand Portal das Eigenschaftsprädikat für Teilsuche auf Asset-Titel anwendet.
...
Mit Brand Portal 6.4.3 werden ein alternativer Alias für Zugriffs-URLs, eine neue Ordnerhierarchie und Verbesserungen bei der Videounterstützung eingeführt. Außerdem werden geplante Veröffentlichungen von AEM Author in Brand Portal und weitere Betriebsverbesserungen eingeführt sowie Kundenwünsche berücksichtigt.
...
Benutzende, deren AEM-Autoreninstanz sich im Dynamic Media-Hybridmodus befindet, können – zusätzlich zu den Originalvideodateien – Dynamic Media-Ausgabedastellungen in der Vorschau ansehen und herunterladen.

Um die Vorschau und den Download von Dynamic Media-Ausgabedarstellungen für bestimmte Mandantenkonten zu aktivieren, geben Admins eine **Dynamic Media-Konfiguration** an. Bei diesem Schritt müssen auch die Videodienst-URL und Registrierungs-ID in der **Video**-Konfiguration im Admin-Tools-Panel angegeben werden.
...
Unternehmen können ihre Portal-URL mit einem alternativen Präfix in der URL anpassen. Um einen Alias für den Mandantenamen in der vorhandenen Portal-URL zu erhalten, müssen Unternehmen sich mit dem Adobe-Support in Verbindung setzen.

Beachten Sie, dass nur das Präfix der Brand Portal-URL angepasst werden kann, aber nicht die gesamte URL.\
...
Eine AEM-Autoreninstanz kann jedoch nur mit der Mandanten-ID-URL [konfiguriert](https://experienceleague.adobe.com/de/docs/experience-manager-65/content/assets/brandportal/configure-aem-assets-with-brand-portal) werden und nicht mit der (alternativen) Mandanten-Alias-URL.
...
Brand Portal 6.4.2 bietet Funktionen für die Asset-Verteilung in Organisationen und ermöglicht dank Gastzugriff und schnelleren Downloads eine globale Reichweite. Darüber hinaus erhalten Organisationen neue Konfigurationsoptionen für Admins und einen neu hinzugefügten Bericht. Zudem wurden Kundenanfragen berücksichtigt.
...
Brand Portal-Benutzende können mit der IBM® Aspera Connect-basierten Download-Beschleunigung – unabhängig von ihrem globalen Standort – bis zu 25-mal höhere Geschwindigkeiten erzielen und einen unterbrechungsfreien Download genießen. Um Assets schneller aus Brand Portal oder über den freigegebenen Link herunterzuladen, müssen Benutzende die Option **Download-Beschleunigung aktivieren** im Dialogfeld „Herunterladen“ auswählen, sofern die Download-Beschleunigung im Unternehmen aktiviert ist.
...
Es wurde ein neuer Bericht zum Nachverfolgen von Benutzeranmeldungen eingeführt. Der Bericht **Benutzeranmeldungen** bietet Organisationen die Möglichkeit, die delegierten Admins und andere Benutzer von Brand Portal zu überwachen und zu kontrollieren.

Der Bericht enthält den Anzeigenamen, die E-Mail-IDs, die Rollen (Admin, Betrachter, Bearbeiter, Gast), die Gruppen, Angaben zur letzten Anmeldung, den Aktivitätsstatus und die Anzahl der Anmeldungen von jeder Person seit der Bereitstellung von Brand Portal 6.4.2 bis zum Zeitpunkt der Berichterstellung. Admins können den Bericht als CSV-Datei exportieren. Der Bericht „Benutzeranmeldungen“ gestattet Organisationen in Verbindung mit anderen Berichten eine genauere Überwachung der Benutzerinteraktionen mit den genehmigten Brand-Ressourcen und gewährleistet so die Einhaltung von Vorschriften der Corporate Compliance Offices.

![](assets/user-logins-1.png)

### Zugriff auf die Original-Ausgabedarstellungen

Admins können den Zugriff auf Original-Bilddateien einschränken und den Zugriff auf Ausgabeformate mit niedrigerer Auflösung gewähren, die sich von Brand Portal oder über einen freigegebenen Link herunterladen lassen. Dieser Zugriff kann auf Benutzergruppenebene über die Registerkarte „Gruppen“ auf der Seite „Benutzerrollen“ gesteuert werden.

![](assets/access-original-rend-1.png)

* Standardmäßig sind alle Benutzenden berechtigt, Original-Ausgabedarstellungen herunterzuladen, da die Option „Zugriff auf Original“ für alle aktiviert ist.
* Admins müssen die Auswahl der entsprechenden Kontrollkästchen deaktivieren, um zu verhindern, dass eine Gruppe von Benutzenden auf Original-Ausgabeformate zugreift.
...
Auf den Karten von Ordnern in der Kartenansicht werden für Benutzende ohne Administratorrechte (Bearbeiter, Betrachter und Gastbenutzer) jetzt Informationen zur Ordnerhierarchie angezeigt. Diese Funktion informiert die Benutzenden über den Speicherort der Ordner, auf die sie zugreifen, in Bezug auf die übergeordnete Hierarchie.

Informationen zur Ordnerhierarchie sind insbesondere bei der Unterscheidung von Ordnern hilfreich, deren Namen identisch sind mit Namen anderer freigegebener Ordner in einer anderen Ordnerhierarchie. Wenn Benutzende ohne Administratorrechte nicht die Ordnerstruktur der für sie freigegebenen Assets berücksichtigen, können Assets/Ordner mit denselben Namen für Verwirrung sorgen.

* Die auf den entsprechenden Karten angezeigten Pfade werden so gekürzt, dass sie zu den Kartengrößen passen. Die Benutzenden können den vollständigen Pfad jedoch in einer QuickInfo sehen, wenn sie den Mauszeiger über den verkürzten Pfad bewegen.

![](assets/folder-hierarchy1-1.png)

Die Listenansicht zeigt allen Benutzenden von Brand Portal den Ordnerpfad der Assets in einer Spalte an.

![](assets/list-view-1.png)

### Option „Überblick“ zur Anzeige der Asset-Eigenschaften

Brand Portal stellt Benutzenden ohne Administratorrechte (Bearbeiter, Betrachter und Gastbenutzer) mit der Option „Überblick“ eine Funktion zum Anzeigen von Asset-Eigenschaften von ausgewählten Assets/Ordnern bereit. Die Option „Überblick“ finden Sie an folgenden Stellen:
...
Bei Auswahl der Option „Überblick“ bei ausgewähltem Asset/Ordner können die Benutzenden den Titel, den Pfad und den Zeitpunkt der Asset-Erstellung sehen. Wohingegen die Benutzenden bei Auswahl der Option „Überblick“ auf der Asset-Detailseite die Metadaten des Assets sehen können.
...
Die zuvor genannten Konfigurationen sind unter „Zugriff“ und „Allgemeine Einstellungen“ im Admin-Tools-Panel verfügbar.
...
Seit Brand Portal 6.4.2 wird die alte OAuth-Schnittstelle (`https://legacy-oauth.cloud.adobe.io/`) zum Erstellen der JWT-Anwendung verwendet, über die OAuth-Integrationen so konfiguriert werden können, dass sie eine AEM Assets-Integration in Brand Portal unterstützen. Zuvor wurde die Benutzeroberfläche zum Konfigurieren von OAuth-Integrationen unter `https://marketing.adobe.com/developer/` gehostet. Weitere Informationen zur Integration von AEM Assets mit Brand Portal, um Assets und Sammlungen in Brand Portal zu veröffentlichen, finden Sie unter [Konfigurieren der Integration von AEM Assets mit Brand Portal](https://experienceleague.adobe.com/de/docs/experience-manager-65/content/assets/brandportal/configure-aem-assets-with-brand-portal).

## Verbesserungen bei der Suche

Admins können die Eigenschaftsprädikate so konfigurieren, dass nicht zwischen Groß- und Kleinschreibung unterschieden wird, indem sie das aktualisierte Eigenschaftsprädikat nutzen. Dieses verfügt über ein Kontrollkästchen zum Ignorieren von Groß- und Kleinschreibung. Die Option ist für ein Eigenschaftsprädikat und für ein Eigenschaftsprädikat mit mehreren Werten verfügbar.\
Eine Suche, bei der nicht zwischen Groß- und Kleinschreibung unterschieden wird, ist vergleichsweise langsamer als die Standardsuche nach Eigenschaftsprädikat. Wenn es im Suchfilter zu viele Prädikate gibt, bei denen nicht zwischen Groß- und Kleinschreibung unterschieden wird, kann sich die Suche verlangsamen. Adobe empfiehlt, die Suche ohne Unterscheidung der Groß-/Kleinschreibung umsichtig zu verwenden.

## Änderungen in Version 6.4.1 {#what-changed-in-2}

Brand Portal 6.4.1 ist eine Plattform-Upgrade-Version. Es werden mehrere neue Funktionen und wichtige Verbesserungen wie das Durchsuchen und Suchen sowie Leistungsverbesserungen eingeführt.

### Verbesserungen beim Durchsuchen

* Dank der neuen Inhaltsstrukturleiste können Benutzende schnell in Asset-Hierarchien navigieren.

![](assets/contenttree-2.png)

* Neue Tastaturbefehle, zum Beispiel _(p)_ für die Navigation zur Eigenschaftsseite, _(e)_ zum Bearbeiten und _(Strg+c)_ zum Kopieren.
* Verbesserte Scroll-Funktion und Möglichkeit des verzögerten Ladens in der Karten- und Listenansicht beim Durchsuchen einer großen Anzahl von Elementen.
* Verbesserte Kartenansicht mit Unterstützung für Karten unterschiedlicher Größe basierend auf der Anzeigeeinstellung.

![](assets/cardviewsettings-1.png)

* Die Kartenansicht zeigt jetzt beim Bewegen des Mauszeigers über der Datumsangabe einen Datums-/Zeitstempel an.
...
* Neue Funktion „Zugehörige Assets“ in den Asset-Eigenschaften verfügbar. Bei verknüpften Assets, die aus AEM in Brand Portal veröffentlicht wurden, bleiben die Beziehungen erhalten, einschließlich der Links zu den zugehörigen Assets auf der Seite „Asset-Eigenschaften“.
* Eine neue Konfiguration verhindert, dass Nicht-Administrator-Benutzende öffentliche Sammlungen erstellen können. Unternehmen können sich an den Adobe-Support wenden, um diese Funktion für bestimmte Konten zu konfigurieren.
...
* Verbesserter Suchfilter für Dateitypen mit der Möglichkeit, Suchergebnisse basierend auf differenzierten MIME-Typen wie .jpg, .png und .psd zu filtern, anstatt lediglich weiter gefasste Kategorien wie Bilder, Dokumente, Multimedia zu verwenden.
...
* Einzelne große Dateien werden direkt heruntergeladen und nicht erst in eine ZIP-Datei gepackt. Dadurch werden Geschwindigkeit und Durchsatz verbessert.
...
Ein neuer Bericht wurde eingeführt, der Informationen zu freigegebenen Links bereitstellt. Der Bericht zur Link-Freigabe führt alle URLs zu Assets auf, die für interne und externe Benutzende im Unternehmen freigegeben wurden. Er bezieht sich dabei auf Benutzende im gesamten Unternehmen innerhalb des angegebenen Zeitraums. Zusätzlich enthält der Bericht Informationen zum Zeitpunkt der Link-Freigabe und zu dessen Ablaufdatum sowie dazu, wer den Link freigegeben hat.

![](assets/navigatereport.png)

**Einstiegspunkt für den Zugriff auf den Verwendungsbericht geändert**
Der Verwendungsbericht ist jetzt mit anderen Berichten konsolidiert und kann in der Konsole „Asset-Berichte“ angezeigt werden. Um auf die Konsole „Asset-Berichte“ zuzugreifen, klicken Sie im Admin-Tools-Panel auf **Berichte erstellen/verwalten**.
...
Verbesserte Eigenschaftenauswahl in den Admin-Tools für Metadaten, Suche und Berichte mit Vervollständigungs- und Suchfunktion, um die Abläufe für Admins zu vereinfachen.

### Weitere Verbesserungen

* In Brand Portal aus AEM 6.3.2.1 und 6.4 veröffentlichte Assets können jetzt für alle Brand Portal-Benutzenden verfügbar gemacht werden, indem das Kontrollkästchen „Öffentlichen Ordner veröffentlichen“ im Dialogfeld „AEM Assets Brand Portal-Replikation“ aktiviert wird.

![](assets/public-folder-publish.png)

* Wenn Benutzende um Zugriff auf Brand Portal bitten, erhalten Admins zusätzlich zur Benachrichtigung im Brand Portal-Benachrichtigungsbereich eine E-Mail über die Zugriffsanforderung.
...
Der Bericht zu heruntergeladenen Assets enthält jetzt die Anzahl der Asset-Downloads pro Benutzerin bzw. Benutzer innerhalb des angegebenen Datums- und Zeitbereichs. Die Benutzenden können diesen Bericht im .csv-Format herunterladen und Daten wie die Gesamtzahl der Downloads für ein lizenziertes Asset kompilieren.
...
Weitere Informationen finden Sie unter [Wartungsbenachrichtigung in Brand Portal](https://experienceleague.adobe.com/de/docs/experience-manager-brand-portal/using/introduction/brand-portal).
...
Die Asset-Sortierung in einem Ordner in der Listenansicht ist nicht mehr auf die Anzahl der Assets auf der ersten Seite beschränkt. Stattdessen werden alle Assets sortiert, nicht nur die, die auf der ersten Seite angezeigt werden.

### Erweitertes Reporting {#reporting-capabilities}

Admins können drei Berichtstypen erstellen und verwalten – zu heruntergeladenen, abgelaufenen und veröffentlichten Assets. Die Möglichkeit, die Spalten in einem Bericht zu konfigurieren und die Berichte als CSV-Datei zu exportieren, besteht ebenfalls.
...
* Nachdem Admins neue Benutzende hinzugefügt haben, werden diese automatisch in Brand Portal aufgenommen, ohne erst eine Einladung annehmen zu müssen.

### Neue Veröffentlichungsfunktionen in AEM Assets 6.3 {#new-publishing-capabilities-in-aem-assets}

* AEM-Admins können mithilfe von AEM 6.3 SP 1-CFP 1 (6.3.1.1) (seit dem 4. Quartal 2017 verfügbar) Metadatenschemata aus AEM Assets in Brand Portal veröffentlichen.

![](assets/publish_metadataschemaaemassets.png)

* AEM-Admins können mithilfe von AEM 6.2 SP1-CFP7 und AEM 6.3 SP 1-CFP 1 (6.3.1.1) alle Tags aus AEM Assets in Brand Portal veröffentlichen.
